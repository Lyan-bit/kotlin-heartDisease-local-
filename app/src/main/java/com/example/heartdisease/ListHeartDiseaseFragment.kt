...
class ListHeartDiseaseFragment : Fragment() { 
	...
	override fun onResume() {
		super.onResume()
		(root as RecyclerView).adapter = HeartDiseaseRecyclerViewAdapter(model.listHeartDisease(), mListener!!)
	}
	...
	interface OnListHeartDiseaseFragmentInteractionListener {
		fun onListHeartDiseaseFragmentInteraction(item: HeartDiseaseVO)
	}
}
