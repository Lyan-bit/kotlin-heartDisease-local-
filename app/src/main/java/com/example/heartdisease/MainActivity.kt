...
class MainActivity : AppCompatActivity(), ListHeartDiseaseFragment.OnListHeartDiseaseFragmentInteractionListener  {
       	...
       	override fun onListHeartDiseaseFragmentInteraction(item: HeartDiseaseVO) {
